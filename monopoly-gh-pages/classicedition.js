function Square(name, pricetext, color, price, groupNumber, baserent, rent1, rent2, rent3, rent4, rent5, question, answer, explanation) {
	this.name = name;
...
square[1] = new Square("Market Theatre", "$60", "#8B4513", 60, 3, 2, 10, 30, 90, 160, 250, "2+2", "4", "123");
square[2] = new Square("Community Chest", "FOLLOW INSTRUCTIONS ON TOP CARD", "#FFFFFF");
square[3] = new Square("Mandela Brige", "$60", "#8B4513", 60, 3, 4, 20, 60, 180, 320, 450, "45-15", "30", "123");
square[4] = new Square("City Tax", "Pay $200", "#FFFFFF");
square[5] = new Square("Table Mountain", "$200", "#FFFFFF", 200, 1, 0, 0, 0, 0, 0, 0, "5*9", "45", "123");
...
square[30] = new Square("Go to Detention", "Go directly to Jail. Do not pass GO. Do not collect $200.", "#FFFFFF");
square[31] = new Square("Addition", "$300", "#008000", 300, 9, 26, 130, 390, 900, 110, 1275);
